...
<?php endif; ?>
  ...
  <div class="search-result-description">
    ...
    <?php endif; ?>
    <?php if (null !== $arrangement = get_search_i18n($doc, 'arrangement', array('culture' => $culture))): ?>
      <p class="arrangement"><span><?php echo __('In'); ?>: </span><?php echo truncate_text(strip_tags(render_value($arrangement)), 2000) ?></p>
    <?php endif; ?>
