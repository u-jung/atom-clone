	...
	function showMap(){
	   ...
	   /**
		  ...
		  historic_layer=new ol.layer.Tile({
			  source: new ol.source.OSM({url: '/plugins/arArchivesCanadaPlugin/images/tiles/{z}/{x}/{-y}.png',
		   ...
		   */
			...
			/*jQuery(".ol-attribution").css("height","100px");
			jQuery(".ol-attribution").css("top","20px");	*/
...
/***********************************************  Wikidata ****************************************************************** */		
	...
	function showWD(){
		saveContent();
		jQuery("#main-column").html('<div class="multiline-header"><h1 aria-describedby="">Thesaurus<div class="loader"></div></h1></div><section class="breadcrumb"></section><div id="content"></div>')
		WdInit();
...
/*****************************************************  Loading Scripts ***********************************************/
 ...
 function load_wd(){
 		/*jQuery.getScript('/plugins/arArchivesCanadaPlugin/js/wikidata.js', function(){  */
