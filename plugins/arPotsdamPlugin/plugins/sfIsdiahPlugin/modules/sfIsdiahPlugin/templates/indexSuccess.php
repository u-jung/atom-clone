...
<?php if (isset($latitude) && isset($longitude)): ?>
  <div id="front-map" class="simple-map"  data-latitude="<?php echo $latitude ?>" data-longitude="<?php echo $longitude ?>"></div>
...
<section id="collections">
	<span anchor="collections_area" title="Collections"><h2><?php echo __('Holdings') ?></h2></span>
	<div class="field">
		<h3></h3>
		<div>
