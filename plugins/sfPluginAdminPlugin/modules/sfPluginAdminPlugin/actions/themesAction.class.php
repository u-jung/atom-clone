...
class sfPluginAdminPluginThemesAction extends sfAction
{
  ...
  /*    	         print '<br />';
	         print_r($className);
	         print '<br />';
	         print_r (sfConfig::get('sf_plugins_dir'));
	          print '<br />';
	          print substr($path, 0, strlen(sfConfig::get('sf_plugins_dir')));
	           print '<br />';
	          print is_readable($classPath = $path.'/config/'.$className.'.class.php');
	          print '<br />';
	          print $path.'/config/'.$className.'.class.php';
	           print '<br /><br />';*/
