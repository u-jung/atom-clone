This is the final version used for the project: 
# "Archive guide to the German Colonial Past"
2017 - 2019
by Fachhochschule Potsdam
FB Informationswissenschaften
[www.archivfuehrer-kolonialzeit.de]

# Main changes:
  * added a plugin arPotsdamPlugin
  * added some additional php scripts in root (get.php; esq.php; search_places.php; search_places.php, etc). Theese scripts are used for additional searches at the map browser and the old German typewriter. SOme of them should be startet by cron jobs


Note:
There is are a directory arPotsdamPlugin/images/tiles which usualy contains the tiles for the map section. Because this is a very large directory, it has not been included into this repository. You may get access to this tiles via the URL template https://archivfuehrer-kolonialzeit.de/plugins/arPotsdamPlugin/images/tiles/*{zoom}/{lon}/{lat}*. The tool has 16 zoom levels.


Another note:
Please change twice *{your password}* with your MySql root password in *get.php*
